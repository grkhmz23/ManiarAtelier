...
export const FullScreenScrollFX = forwardRef<HTMLDivElement, FullScreenFXProps>(
  (
    ...
    const cssVars: CSSProperties = {
      ...
      ["--fx-text" as any]: colors.text ?? "#F4E5A7",
      ["--fx-overlay" as any]: colors.overlay ?? "rgba(7,8,23,0.45)",
      ["--fx-page-bg" as any]: colors.pageBg ?? "#070817",
      ["--fx-stage-bg" as any]: colors.stageBg ?? "#070817",
    ...
    return (
      ...
      >
        ...
        <style>{`
          ...
          .fx-bg-overlay {
            position: absolute; inset: 0; background: var(--fx-overlay);
          }
          ...
          .fx-right-item.active::after {
            ...
            width: 6px; height: 6px; background: #D6AC54; border-radius: 50%;
          }
          ...
          .fx-footer {
            grid-column: 1 / 13; align-self: end; padding-bottom: 5vh;
            text-align: center;
          }
          .fx-footer-title {
          ...
          .fx-progress {
            ...
            background: rgba(214,172,84,0.28); position: relative;
          }
          .fx-progress-fill {
            position: absolute; inset: 0 auto 0 0; width: 0%;
            background: #D6AC54; height: 100%; transition: width 0.3s ease;
          }
          .fx-progress-numbers {
            position: absolute; inset: auto 0 100% 0; display: flex;
            justify-content: space-between; font-size: 0.8rem; color: var(--fx-text);
          }
          ...
          .fx-fin {
            transform: rotate(90deg); color: rgba(244,229,167,0.4);
